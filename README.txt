This repository contains messy code for practicing the Mikado Method, refactorings and restructurings, clean code and object-oriented design.
...
-- Easy level
Background: The PhysicalObject is to be used in another project. However, the entire Space class must NOT be shared. Your task is to extract the PhysicalObject to a new project. 
Goal: Enable reuse of PhysicalObject

-- Intermediate level
Background: The solar system and bouncing balls applications are to be sold in separate delivery packages. Due to legal issues, the solar system may not contain any bouncing balls logic and vice versa.
